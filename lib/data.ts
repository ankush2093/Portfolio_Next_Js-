export const projects = [
  ...
  {
    title: "Study-Notion",
    description: "StudyNotion is a full-stack MERN project featuring Student, Instructor, and Admin roles. It enables course management, user authentication, and role-based access, providing a seamless learning experience with dynamic interactions between students and instructors.",
  ...
  {
    title: "AIF Horizon",
    description: "We will Developed a real-time Internship Web Platform using the MERN stack, integrating features such as various internship listings. ",
...

  {
    ...
    description: "Video Chat App is a real-time communication platform built with WebSocket integration. It enables seamless video and text chat without a database, ensuring fast and efficient peer-to-peer interactions.",
...
export const skills = [
  ...
  {
    title: "Bootstrap",
    img: "/img/bootstrap-5.png",
  },
  {
    title: "Twilwind",
    img: "/img/tailwind-css-icon.png",
  },
  {
    title: "React",
    img: "img/react.png",
  ...
  {
    title: "SQL",
    img: "img/sql-file-icon.png",
  },
  {
    title: "Thunder Client",
    img: "img/thundher-client.png",
  },
  {
    title: "Git-Hub",
    img: "img/github-icon.png",
  },
];